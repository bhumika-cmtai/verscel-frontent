        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="space-y-4 sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/hanuman.devloper" className="text-gray-400 hover:text-orange-500 transition-colors">
                <span className="sr-only">Facebook</span>
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M20 10C20 4.477 15.523 0 10 0S0 4.477 0 10c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V10h2.54V7.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V10h2.773l-.443 2.89h-2.33v6.988C16.343 19.128 20 14.991 20 10z" clipRule="evenodd" />
                </svg>
              </a>
              <a href="https://www.instagram.com/hanuman_construction/" className="text-gray-400 hover:text-orange-500 transition-colors">
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="space-y-2 sm:space-y-3">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <a href="tel:+919009599919" className="text-gray-300 hover:text-orange-500 transition-colors text-xs sm:text-sm">
                  +91 9009599919
                </a>
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <a href="mailto:Pankaj@hanumanbuilder.com" className="text-gray-300 hover:text-orange-500 transition-colors text-xs sm:text-sm break-all">
